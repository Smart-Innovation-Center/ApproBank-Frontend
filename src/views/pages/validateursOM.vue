  ...
  <v-app>
    <div class="wrapper">
        ...
        >
          <div class="container-fluid">
            <div class="navbar-wrapper">
              <a class="navbar-brand" href="javascript:;">Validateurs Orange Money CI</a>
                ...
                <template>
                  ...
                  <template v-slot:top>
                    ...
                    <v-toolbar
                      flat
                    >
                      <v-toolbar-title>Liste des validateurs OMCI ({{ validatorsOM.length }})</v-toolbar-title>
                        <v-divider
                          class="mx-15"
                          inset
                          vertical
      ...
      ></v-text-field>
                        ...
                        <v-card>
                          <v-card-title>
                            <span class="headline">Nouveau Validateur</span>
                          </v-card-title>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      validatorsOM: "validatorOM/validatorsOM"
    }),
    ...mapState({
      validatorsOM: state => state.validatorOM.validatorsOM
    }),
  },
  watch: {
      dialog (val) {
  ...
  methods: {
    ...mapActions({
      ...
      validatorsOMAd: "validatorOM/addvalidatorsOM",
      ...
      save () {
        ...
        this.validatorsOMAd(this.editedItem);
        this.validatorsOM.push(this.editedItem);
  ...
  mounted() {
    this.$store.dispatch("validatorOM/validatorsOM");
  }
};
</script>