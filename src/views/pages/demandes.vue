        ...
        >
          <div class="container-fluid">
            <div class="navbar-wrapper">
              <a class="navbar-brand" to="javascript:;"
                      ...
                      <table class="table table-stripped" id="table">
                        ...
                        <tbody>
                          <tr v-for="(supplyAvecB, index) in suppliesAvecB" :key="supplyAvecB.id">
                            ...
                            <td class="font-weight-bold text-uppercase">
                              <a :href="'http://localhost:8000/storage/'+ supplyAvecB.photo_bordereau" target="_blank">
                                <img :src="'http://localhost:8000/storage/'+ supplyAvecB.photo_bordereau" alt="photoBordereau" class="my-3" contain height="100" />
                              </a>
                            </td>
                            <td class="text-info">
                              <button
          ...
          <div class="card card-signup card-plain">
            ...
            <div class="card-body">
              <v-card>
                <v-img
                  height="200"
                  :src="'http://localhost:8000/storage/'+ viewSupplyAvecItem.photo_bordereau" alt="photoBOrdereau"
                ></v-img>
          ...
          <div class="card card-signup card-plain">
            ...
            <div class="card-body">
              <v-card>
                <v-img
                  height="200"
                  :src="'http://localhost:8000/storage/'+ approSupplyAvecItem.photo_bordereau" alt="photoBOrdereau"
                ></v-img>
          ...
          <div class="card card-signup card-plain">
            ...
            <div class="card-body">
              <v-card>
                <v-img
                  height="200"
                  :src="'http://localhost:8000/storage/'+ rejSupplyAvecItem.photo_bordereau" alt="photoBOrdereau"
                ></v-img>
                <v-card-title>
